...
/**
 * Modified from Glitchfiend's Biomes O' Plenty code
 * 
 * @author Glitchfiend
 * @author zNick_
 *
...
public class BigTreeGenerator extends WorldGenAbstractTree {
	...
	private static final byte[] COORD_PAIRS = new byte[] { (byte) 2, (byte) 0, (byte) 0, (byte) 1, (byte) 2, (byte) 1 };
	...
	public BigTreeGenerator(Block wood, Block leaves) {
		super(false);
		this.wood = wood;
		this.leaves = leaves;
	}
	...
	private void func_150529_a(int p_150529_1_, int p_150529_2_, int p_150529_3_, float p_150529_4_, byte p_150529_5_, Block p_150529_6_) {
		int l = (int) ((double) p_150529_4_ + 0.618D);
		byte b1 = COORD_PAIRS[p_150529_5_];
		byte b2 = COORD_PAIRS[p_150529_5_ + 3];
	...
	private void func_150530_a(int[] p_150530_1_, int[] p_150530_2_, Block p_150530_3_) {
		...
		if (aint2[b1] != 0) {
			byte b2 = COORD_PAIRS[b1];
			byte b3 = COORD_PAIRS[b1 + 3];
			byte b4;
