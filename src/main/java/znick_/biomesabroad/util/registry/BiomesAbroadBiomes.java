...
import znick_.biomesabroad.biome.cypresscliffs.CypressCliffs;
...
import znick_.biomesabroad.biome.snowypeaks.SnowyPeaks;
...
public final class BiomesAbroadBiomes {
	...
	public static final BaseBiome CYPRESS_CLIFFS = new CypressCliffs();
	...
	public static final BaseBiome SNOWY_PEAKS = new SnowyPeaks();
