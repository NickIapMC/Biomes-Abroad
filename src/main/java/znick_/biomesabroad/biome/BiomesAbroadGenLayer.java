...
public class BiomesAbroadGenLayer extends GenLayer {
	private List<BiomeEntry>[] biomes = new ArrayList[BiomeManager.BiomeType.values().length];

	private static final String __OBFID = "CL_00000555";
	public static ArrayList<BiomeGenBase> customBiomes = new ArrayList<BiomeGenBase>();

	public BiomesAbroadGenLayer(long p_i2122_1_, GenLayer p_i2122_3_, WorldType p_i2122_4_) {
		super(p_i2122_1_);
...
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomeWasteland, 10));
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomeCartoonHills, 10));
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomeRetro, 10));
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomeRainbowForest, 10));
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomeOvergrownMountains, 10));
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomeWinterWonderland, 10));
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomePirateShores, 10));
//		biomes[desertIdx].add(new BiomeEntry(BiomesManager.biomeStarfield, 10));

		for (BiomeGenBase b : BiomesAbroadGenLayer.customBiomes) {
			biomes[desertIdx].add(new BiomeEntry(b, 10));
		}
	}
			...
			for (int j1 = 0; j1 < p_75904_3_; ++j1) {
				...
				if (isBiomeOceanic(k1)) {
					...
					if (l1 > 0) {
						...
						aint1[j1 + i1
								* p_75904_3_] = getWeightedBiomeEntry(BiomeManager.BiomeType.DESERT).biome.biomeID;
					}
				} else if (k1 == 2) {
					if (l1 > 0) {
	...
	public static <Biome extends BiomeGenBase> void addBiome(Biome biome) {
		BiomesAbroadGenLayer.customBiomes.add(biome);
	}
}